...
CREATE CLUSTERED INDEX cix_BasicPolInfo_PolId
    ON Staging.AMS_BasicPolInfo (PolId);

CREATE CLUSTERED INDEX cix_BasicPolInfo_PolId
    ON RawData.AMS_BasicPolInfo (PolId);
GO
...
BEGIN
    ...
    INSERT INTO Staging.AMS_BasicPolInfo (BasicPolInfoChecksum
                                          , Datasource
                                          , Deleted
                                          , Sequencenumber
                                          , AgcyBusClass
