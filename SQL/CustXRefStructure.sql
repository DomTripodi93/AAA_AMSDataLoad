...
CREATE CLUSTERED INDEX cix_CustXRef_CustXRefId
    ON Staging.AMS_CustXRef (CXRefId);

CREATE CLUSTERED INDEX cix_CustXRef_CustXRefId
    ON RawData.AMS_CustXRef (CXRefId);
GO
...
BEGIN
    ...
    INSERT INTO Staging.AMS_CustXRef (CustXRefChecksum
                                      , Datasource
                                      , Deleted
                                      , Sequencenumber
                                      , AXRefId
