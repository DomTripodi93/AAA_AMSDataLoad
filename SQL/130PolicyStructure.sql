...
CREATE CLUSTERED INDEX cix_130Policy_WPolId
    ON Staging.AMS_130Policy (WPolId);

CREATE CLUSTERED INDEX cix_130Policy_WPolId
    ON RawData.AMS_130Policy (WPolId);
GO
...
BEGIN
    ...
    INSERT INTO Staging.AMS_130Policy (PolicyChecksum
                                       , Datasource
                                       , Deleted
                                       , Sequencenumber
                                       , AddInfo
