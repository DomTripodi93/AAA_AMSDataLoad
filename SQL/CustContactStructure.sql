...
CREATE CLUSTERED INDEX cix_CustContact_CCntId ON Staging.AMS_CustContact(CCntId)
CREATE CLUSTERED INDEX cix_CustContact_CCntId ON RawData.AMS_CustContact(CCntId)
