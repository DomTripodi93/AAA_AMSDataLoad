...
CREATE CLUSTERED INDEX cix_PolicyTransaction_PolId ON Staging.AMS_PolicyTransaction(PolId)
CREATE CLUSTERED INDEX cix_PolicyTransaction_PolId ON RawData.AMS_PolicyTransaction(PolId)
