...
CREATE CLUSTERED INDEX cix_PolicyTransaction_PolId_EffDate
    ON Staging.AMS_PolicyTransaction (PolId, EffDate);

CREATE CLUSTERED INDEX cix_PolicyTransaction_PolId_EffDate
    ON RawData.AMS_PolicyTransaction (PolId, EffDate);
GO
...
BEGIN
    ...
    INSERT INTO Staging.AMS_PolicyTransaction (PolicyTransactionChecksum
                                               , Datasource
                                               , Deleted
                                               , Sequencenumber
                                               , BilledNonPrem
    ...
    SELECT  AMS_PolicyTransaction.PolicyTransactionChecksum
      ...
      FROM  (
                SELECT  *
                        , ROW_NUMBER () OVER (PARTITION BY AMS_PolicyTransaction.PolId
                                                           , AMS_PolicyTransaction.EffDate
