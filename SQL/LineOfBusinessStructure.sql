...
CREATE CLUSTERED INDEX cix_LineOfBusiness_LOBId_PolId ON Staging.AMS_LineOfBusiness(LOBId, PolId)
CREATE CLUSTERED INDEX cix_LineOfBusiness_LOBId_PolId ON RawData.AMS_LineOfBusiness(LOBId, PolId)
...
BEGIN
    ...
    --FROM  RawData.AMS_LineOfBusiness;
      FROM  (
                SELECT  *
                        , ROW_NUMBER () OVER (PARTITION BY AMS_LineOfBusiness.LOBId, AMS_LineOfBusiness.PolId
