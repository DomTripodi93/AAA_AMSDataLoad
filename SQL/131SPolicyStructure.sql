...
CREATE CLUSTERED INDEX cix_131SPolicy_UPolId ON Staging.AMS_131SPolicy(UPolId)
CREATE CLUSTERED INDEX cix_131SPolicy_UPolId ON RawData.AMS_131SPolicy(UPolId)
